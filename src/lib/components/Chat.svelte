<script lang="ts">
	...
	// Generate an image locally from a prompt via ComfyUI.
...
>
	...
	<footer class="border-t border-[#2b2f3a] px-7 py-4">
		<div class="mx-auto max-w-prose">
			...
			<!-- Local image generation (ComfyUI / FLUX.1-dev) -->
			<div class="mt-4 border-t border-[#232733] pt-4">
				<div class="flex items-center justify-between gap-3">
					...
					>
						...
						></span>
						{comfyUp ? 'ComfyUI ready' : 'ComfyUI offline'}
					</span>
				</div>
